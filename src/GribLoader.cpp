	  ...
	  logHandler_(logHandler)
{
	...
	Grib2ValueParameter1_.open( getConfigFile("valueparameter1.conf").file_string() );
	Grib2LevelParameter1_.open( getConfigFile("levelparameter1.conf").file_string() );
	Grib2LevelAdditions1_.open( getConfigFile("leveladditions1.conf").file_string() );
	Grib2ValueParameter2_.open( getConfigFile("valueparameter2.conf").file_string() );
	Grib2LevelParameter2_.open( getConfigFile("levelparameter2.conf").file_string() );
	Grib2LevelAdditions2_.open( getConfigFile("leveladditions2.conf").file_string() );
}
